...
export default function MobileAppBanner() {
  ...
  return (
    <div className="bg-brand-gradient text-white px-4 py-3 relative shadow-glow-ember">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
            ...
            {isIOS && (
              <a
                ...
                className="inline-flex items-center gap-1 px-3 py-1 bg-white text-brand-2 rounded-full text-sm font-semibold hover:bg-white/90 transition-colors"
              >
